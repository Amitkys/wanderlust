...
const sampleListings = [
    ...
    {
      title: "Exotic Jungle Villa",
      description:
        "Surrounded by lush greenery, this exotic jungle villa offers a unique and tranquil retreat.",
      image: "https://images.unsplash.com/photo-1530541930197-fc9e2ff9f418?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGJlYWNoJTIwdmFjYXRpb258ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60",
      price: 1800,
      location: "Bali",
      country: "Indonesia",
    },
    {
      title: "Scenic Riverfront Cabin",
      description:
        "Enjoy the tranquility of riverfront living in this scenic cabin, perfect for fishing and canoeing.",
      image: "https://images.unsplash.com/photo-1570961401580-3b0735aa2f8f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8aG90ZWxzfGVufDB8fDB8fHww&auto=format&fit=crop&w=800&q=60",
      price: 1400,
      location: "Great Smoky Mountains",
      country: "United States",
    },
    {
      title: "Tranquil Desert Oasis",
      description:
        "Find peace in the desert at this serene oasis with stunning views and luxurious amenities.",
      image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8aG90ZWxzfGVufDB8fDB8fHww&auto=format&fit=crop&w=800&q=60",
      price: 2200,
    ...
    },
    {
      ...
      description:
        "Relax in luxury at this lakeside villa, complete with a private dock for boating and fishing.",
      image: "https://images.unsplash.com/photo-1576671083798-0413d661d84e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fGJlYWNoJTIwdmFjYXRpb258ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60",
      price: 2600,
      location: "Lake Como",
      country: "Italy",
    },
...
Listing.insertMany(sampleListings).then((result) => {
    console.log(`Sample_listing Added into DB`);
}).catch((err) => {
    console.log(err);
});
